...
class bsession
{
    ...
    public function getcontext($token, $uniqueID)
    {
        ...
        $this->_valueBSession['Params'] = '{"Token": "' . $token . '" , "uniqueID" : "' . $uniqueID . '"}';

        // echo "<pre>";
        //var_dump($this->_valueBSession);
        // die();
        return $this->_valueBSession;
    }

    public function unregister($params)
    {
        $url = "http://appdev.kmn.kompas.com/gmmsapi/BSession/unregister";
        $data = $params;
    ...
    {
        return isset($this->_valueBSession[$item]) ? $this->_valueBSession[$item] : "";
    }
}
